...
class otel {
	...
	enum statu {	//enum fonksiyonu ozellikleri belirtilen nesne oluþturmak için kullanýldý.
		bos, dolu
	}odalar[45];
public:
	otel();
...
otel::otel() {
	...
	sayac2 = 0;
	toplam = 0;
	oda_isletme();		//yapýcý fonsiyon direkt çaðýrýlacaðýndan içine oda isletme yazýldý
}
void otel::oda_isletme() {
	...
	do {
		...
		cout << "\nIslem seciniz : ";
		cin >> sayi;
		//alinan degerin switch case yapýsý ile olasiklarý degerlendirilir.
		switch (sayi)
		{
